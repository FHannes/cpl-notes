...
The procedure |empty-env|, |extend-env| and |apply-env| procedures represent an environment as a linked list, with the empty environment as an empty list.
...
A first alternate representation is a linked list, as seen in exercise 2.5. An alternative to the linked list is a list of pairs:
...
|report-no-binding-found| and |report-invalid-env| are defined in exercise 2.5.
