...
The procedure |number-elements| takes a list of elements and returns a list of pais, where every pair is the index of an element from the original list, paired with the element itself.
